    ...
    <div>
      ...
      <div className="w-full px-[20px] lg:px-[10%] pt-10 pb-20 mt-24 flex flex-col gap-4">
        ...
        <div className="w-full py-4 flex flex-col gap-2">
          ...
          <p className="text-[14px] lg:text-center italic w-full lg:text-center">
        ...
        <div className="w-full lg:w-[80%] lg:mx-auto flex flex-col lg:flex-row gap-10 lg:gap-24 lg:p-8 lg:justify-between">
          <div className="w-full flex flex-col gap-4">
            ...
            <p className="text-[14px] font-bold lg:text-[24px] text-[#cda78f]">
              Our Approach
            </p>
            <p className="text-[14px] text-justify">
            ...
            <div className="flex flex-col gap-2">
              <p className="text-[14px] py-2 px-4 border border-[#cda78f] rounded-lg text-justify transition ease-in-out hover:bg-[#cda78f] hover:text-[#ffffff] custom-hover-transition">
          ...
          <div className="w-full flex flex-col gap-4">
            <p className="text-[14px] lg:text-[24px] font-bold text-[#cda78f]">
