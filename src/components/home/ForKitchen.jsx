      ...
      <div className="w-[90vw] h-full lg:w-[80%] px-[24px] lg:px-0 lg:mx-auto flex justify-start items-end relative">
        <div className="flex flex-col gap-8">
          ...
          <div className="flex justify-start">
            <button
              className="px-4 py-2 text-[#f5f5f7] border border-[#f5f5f7] text-[14px] hover:scale-105 transition ease-in-out hover:bg-[#f5f5f7] hover:text-[#1d1d1f] custom-hover-transition"
              onClick={() => {
